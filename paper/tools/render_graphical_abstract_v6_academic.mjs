...
const htmlPath = `${root}/paper/tools/graphical_abstract_set_reliability_v6_academic.html`;
const pngPath = `${root}/paper/assets/graphical_abstract_set_reliability_v6_academic.png`;
const pdfPath = `${root}/paper/assets/graphical_abstract_set_reliability_v6_academic.pdf`;
